                ...
                <div class="p-6 text-gray-900">
                    <section>
                        ...
                        <form method="post" action="{{ route('update-comment', $comment) }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                <x-input-label for="comment" :value="__('posts.comment')" />
                            ...
                            <div class="flex items-center gap-4">
                                <x-primary-button>{{ __('posts.edit_comment') }}</x-primary-button>
                            </div>
                        </form>
                        <form method="post" action="{{ route('delete-comment', $comment) }}" class="mt-6 space-y-6 flex justify-end">
                            ...
                            <div class="flex items-center gap-4">
                                <x-danger-button>{{ __('posts.delete_comment') }}</x-danger-button>
                            </div>
                        </form>
                    </section>
                </div>
